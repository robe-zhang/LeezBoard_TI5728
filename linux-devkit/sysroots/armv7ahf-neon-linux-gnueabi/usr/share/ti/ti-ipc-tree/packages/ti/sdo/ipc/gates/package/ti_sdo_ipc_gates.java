...
public class ti_sdo_ipc_gates
{
    ...
    void GateHWSpinlock$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sdo_ipc_gates_GateHWSpinlock_Handle__label__E", "ti_sdo_ipc_gates_GateHWSpinlock_Module__startupDone__E", "ti_sdo_ipc_gates_GateHWSpinlock_Object__create__E", "ti_sdo_ipc_gates_GateHWSpinlock_Object__delete__E", "ti_sdo_ipc_gates_GateHWSpinlock_Object__get__E", "ti_sdo_ipc_gates_GateHWSpinlock_Object__first__E", "ti_sdo_ipc_gates_GateHWSpinlock_Object__next__E", "ti_sdo_ipc_gates_GateHWSpinlock_Params__init__E", "ti_sdo_ipc_gates_GateHWSpinlock_query__E", "ti_sdo_ipc_gates_GateHWSpinlock_getReservedMask__E", "ti_sdo_ipc_gates_GateHWSpinlock_sharedMemReq__E", "ti_sdo_ipc_gates_GateHWSpinlock_enter__E", "ti_sdo_ipc_gates_GateHWSpinlock_leave__E"));
    ...
    void GateMPSupportNull$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sdo_ipc_gates_GateMPSupportNull_Handle__label__E", "ti_sdo_ipc_gates_GateMPSupportNull_Module__startupDone__E", "ti_sdo_ipc_gates_GateMPSupportNull_Object__create__E", "ti_sdo_ipc_gates_GateMPSupportNull_Object__delete__E", "ti_sdo_ipc_gates_GateMPSupportNull_Object__get__E", "ti_sdo_ipc_gates_GateMPSupportNull_Object__first__E", "ti_sdo_ipc_gates_GateMPSupportNull_Object__next__E", "ti_sdo_ipc_gates_GateMPSupportNull_Params__init__E", "ti_sdo_ipc_gates_GateMPSupportNull_query__E", "ti_sdo_ipc_gates_GateMPSupportNull_getReservedMask__E", "ti_sdo_ipc_gates_GateMPSupportNull_sharedMemReq__E", "ti_sdo_ipc_gates_GateMPSupportNull_enter__E", "ti_sdo_ipc_gates_GateMPSupportNull_leave__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
