...
#define ti_sdo_ipc_interfaces_INetworkTransport___VERS 200
...
struct ti_sdo_ipc_interfaces_INetworkTransport_Fxns__ {
    ...
    xdc_Int (*bind)(void* __inst, xdc_UInt32 queueId);
    xdc_Int (*unbind)(void* __inst, xdc_UInt32 queueId);
    xdc_Bool (*put)(void* __inst, xdc_Ptr msg);
    xdc_runtime_Types_SysFxns2 __sfxns;
};
#ifndef ti_sdo_ipc_interfaces_INetworkTransport_Module__BASE__CR

/* Interface__BASE__C */
__extern const xdc_runtime_Types_Base ti_sdo_ipc_interfaces_INetworkTransport_Interface__BASE__C;
#else
#define ti_sdo_ipc_interfaces_INetworkTransport_Interface__BASE__C (*((xdc_runtime_Types_Base *)(xdcRomConstPtr + ti_sdo_ipc_interfaces_INetworkTransport_Interface__BASE__C_offset)))
#endif
...
__extern ti_sdo_ipc_interfaces_INetworkTransport_Handle ti_sdo_ipc_interfaces_INetworkTransport_create(ti_sdo_ipc_interfaces_INetworkTransport_Module __mod, const ti_sdo_ipc_interfaces_INetworkTransport_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(ti_sdo_ipc_interfaces_INetworkTransport_delete, "ti_sdo_ipc_interfaces_INetworkTransport_delete")
__extern xdc_Void ti_sdo_ipc_interfaces_INetworkTransport_delete(ti_sdo_ipc_interfaces_INetworkTransport_Handle *__inst);
...
/* bind_{FxnT,fxnP} */
typedef xdc_Int (*ti_sdo_ipc_interfaces_INetworkTransport_bind_FxnT)(xdc_Void *__inst, xdc_UInt32 queueId);
...
/* unbind_{FxnT,fxnP} */
typedef xdc_Int (*ti_sdo_ipc_interfaces_INetworkTransport_unbind_FxnT)(xdc_Void *__inst, xdc_UInt32 queueId);
...
/* put_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sdo_ipc_interfaces_INetworkTransport_put_FxnT)(xdc_Void *__inst, xdc_Ptr msg);
