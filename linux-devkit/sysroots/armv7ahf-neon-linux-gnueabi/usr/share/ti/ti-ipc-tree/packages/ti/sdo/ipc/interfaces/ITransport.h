...
#define ti_sdo_ipc_interfaces_ITransport___VERS 200
...
#ifndef ti_sdo_ipc_interfaces_ITransport_Module__BASE__CR

/* Interface__BASE__C */
__extern const xdc_runtime_Types_Base ti_sdo_ipc_interfaces_ITransport_Interface__BASE__C;
#else
#define ti_sdo_ipc_interfaces_ITransport_Interface__BASE__C (*((xdc_runtime_Types_Base *)(xdcRomConstPtr + ti_sdo_ipc_interfaces_ITransport_Interface__BASE__C_offset)))
#endif
...
__extern ti_sdo_ipc_interfaces_ITransport_Handle ti_sdo_ipc_interfaces_ITransport_create(ti_sdo_ipc_interfaces_ITransport_Module __mod, const ti_sdo_ipc_interfaces_ITransport_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(ti_sdo_ipc_interfaces_ITransport_delete, "ti_sdo_ipc_interfaces_ITransport_delete")
__extern xdc_Void ti_sdo_ipc_interfaces_ITransport_delete(ti_sdo_ipc_interfaces_ITransport_Handle *__inst);
