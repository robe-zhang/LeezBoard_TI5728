...
#define ti_sdo_ipc_gates_GatePeterson___VERS 200
...
typedef volatile xdc_Bits16 *__CARRAY1_ti_sdo_ipc_gates_GatePeterson_Instance_State__flag[2];
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Module__diagsEnabled__CR
#define ti_sdo_ipc_gates_GatePeterson_Module__diagsEnabled__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Module__diagsEnabled*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__diagsEnabled__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__diagsEnabled (ti_sdo_ipc_gates_GatePeterson_Module__diagsEnabled__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Module__diagsIncluded__CR
#define ti_sdo_ipc_gates_GatePeterson_Module__diagsIncluded__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Module__diagsIncluded*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__diagsIncluded__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__diagsIncluded (ti_sdo_ipc_gates_GatePeterson_Module__diagsIncluded__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Module__diagsMask__CR
#define ti_sdo_ipc_gates_GatePeterson_Module__diagsMask__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Module__diagsMask*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__diagsMask__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__diagsMask (ti_sdo_ipc_gates_GatePeterson_Module__diagsMask__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Module__gateObj__CR
#define ti_sdo_ipc_gates_GatePeterson_Module__gateObj__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Module__gateObj*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__gateObj__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__gateObj (ti_sdo_ipc_gates_GatePeterson_Module__gateObj__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Module__gatePrms__CR
#define ti_sdo_ipc_gates_GatePeterson_Module__gatePrms__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Module__gatePrms*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__gatePrms__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__gatePrms (ti_sdo_ipc_gates_GatePeterson_Module__gatePrms__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Module__id__CR
#define ti_sdo_ipc_gates_GatePeterson_Module__id__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Module__id*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__id__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__id (ti_sdo_ipc_gates_GatePeterson_Module__id__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Module__loggerDefined__CR
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerDefined__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Module__loggerDefined*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__loggerDefined__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerDefined (ti_sdo_ipc_gates_GatePeterson_Module__loggerDefined__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Module__loggerObj__CR
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerObj__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Module__loggerObj*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__loggerObj__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerObj (ti_sdo_ipc_gates_GatePeterson_Module__loggerObj__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn0__CR
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn0__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn0*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn0__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn0 (ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn0__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn1__CR
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn1__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn1*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn1__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn1 (ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn1__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn2__CR
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn2__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn2*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn2__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn2 (ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn2__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn4__CR
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn4__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn4*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn4__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn4 (ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn4__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn8__CR
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn8__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn8*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn8__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn8 (ti_sdo_ipc_gates_GatePeterson_Module__loggerFxn8__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Object__count__CR
#define ti_sdo_ipc_gates_GatePeterson_Object__count__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Object__count*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Object__count__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Object__count (ti_sdo_ipc_gates_GatePeterson_Object__count__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Object__heap__CR
#define ti_sdo_ipc_gates_GatePeterson_Object__heap__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Object__heap*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Object__heap__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Object__heap (ti_sdo_ipc_gates_GatePeterson_Object__heap__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Object__sizeof__CR
#define ti_sdo_ipc_gates_GatePeterson_Object__sizeof__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Object__sizeof*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Object__sizeof__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Object__sizeof (ti_sdo_ipc_gates_GatePeterson_Object__sizeof__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_Object__table__CR
#define ti_sdo_ipc_gates_GatePeterson_Object__table__C (*((CT__ti_sdo_ipc_gates_GatePeterson_Object__table*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Object__table__C_offset)))
#else
#define ti_sdo_ipc_gates_GatePeterson_Object__table (ti_sdo_ipc_gates_GatePeterson_Object__table__C)
#endif
...
#ifdef ti_sdo_ipc_gates_GatePeterson_E_gateRemotelyOpened__CR
#define ti_sdo_ipc_gates_GatePeterson_E_gateRemotelyOpened (*((CT__ti_sdo_ipc_gates_GatePeterson_E_gateRemotelyOpened*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_E_gateRemotelyOpened__C_offset)))
#else
...
#ifdef ti_sdo_ipc_gates_GatePeterson_numInstances__CR
#define ti_sdo_ipc_gates_GatePeterson_numInstances (*((CT__ti_sdo_ipc_gates_GatePeterson_numInstances*)(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_numInstances__C_offset)))
#else
...
struct ti_sdo_ipc_gates_GatePeterson_Fxns__ {
    ...
    xdc_IArg (*enter)(ti_sdo_ipc_gates_GatePeterson_Handle __inst);
    xdc_Void (*leave)(ti_sdo_ipc_gates_GatePeterson_Handle __inst, xdc_IArg key);
    xdc_Bits32 *(*getReservedMask)(void);
    xdc_SizeT (*sharedMemReq)(const ti_sdo_ipc_interfaces_IGateMPSupport_Params* params);
    xdc_runtime_Types_SysFxns2 __sfxns;
};
#ifndef ti_sdo_ipc_gates_GatePeterson_Module__FXNS__CR

/* Module__FXNS__C */
__extern const ti_sdo_ipc_gates_GatePeterson_Fxns__ ti_sdo_ipc_gates_GatePeterson_Module__FXNS__C;
#else
#define ti_sdo_ipc_gates_GatePeterson_Module__FXNS__C (*(xdcRomConstPtr + ti_sdo_ipc_gates_GatePeterson_Module__FXNS__C_offset))
#endif
...
__extern xdc_Int ti_sdo_ipc_gates_GatePeterson_Instance_init__E(ti_sdo_ipc_gates_GatePeterson_Object *__obj, xdc_runtime_IGateProvider_Handle localGate, const ti_sdo_ipc_gates_GatePeterson_Params *__prms, xdc_runtime_Error_Block *__eb);

/* Instance_finalize__E */
xdc__CODESECT(ti_sdo_ipc_gates_GatePeterson_Instance_finalize__E, "ti_sdo_ipc_gates_GatePeterson_Instance_finalize")
__extern void ti_sdo_ipc_gates_GatePeterson_Instance_finalize__E(ti_sdo_ipc_gates_GatePeterson_Object *__obj, int __ec);
...
__extern xdc_Ptr ti_sdo_ipc_gates_GatePeterson_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
