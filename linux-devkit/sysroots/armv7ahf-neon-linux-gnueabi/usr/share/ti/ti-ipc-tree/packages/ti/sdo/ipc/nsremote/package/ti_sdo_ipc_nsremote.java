...
public class ti_sdo_ipc_nsremote
{
    ...
    void NameServerMessageQ$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sdo_ipc_nsremote_NameServerMessageQ_Handle__label__E", "ti_sdo_ipc_nsremote_NameServerMessageQ_Module__startupDone__E", "ti_sdo_ipc_nsremote_NameServerMessageQ_Object__create__E", "ti_sdo_ipc_nsremote_NameServerMessageQ_Object__delete__E", "ti_sdo_ipc_nsremote_NameServerMessageQ_Object__get__E", "ti_sdo_ipc_nsremote_NameServerMessageQ_Object__first__E", "ti_sdo_ipc_nsremote_NameServerMessageQ_Object__next__E", "ti_sdo_ipc_nsremote_NameServerMessageQ_Params__init__E", "ti_sdo_ipc_nsremote_NameServerMessageQ_attach__E", "ti_sdo_ipc_nsremote_NameServerMessageQ_detach__E", "ti_sdo_ipc_nsremote_NameServerMessageQ_sharedMemReq__E", "ti_sdo_ipc_nsremote_NameServerMessageQ_get__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
