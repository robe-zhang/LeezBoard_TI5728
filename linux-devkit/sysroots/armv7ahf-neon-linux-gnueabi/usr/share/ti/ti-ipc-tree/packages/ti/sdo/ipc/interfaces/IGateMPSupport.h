...
#define ti_sdo_ipc_interfaces_IGateMPSupport___VERS 200
...
#ifndef ti_sdo_ipc_interfaces_IGateMPSupport_Module__BASE__CR

/* Interface__BASE__C */
__extern const xdc_runtime_Types_Base ti_sdo_ipc_interfaces_IGateMPSupport_Interface__BASE__C;
#else
#define ti_sdo_ipc_interfaces_IGateMPSupport_Interface__BASE__C (*((xdc_runtime_Types_Base *)(xdcRomConstPtr + ti_sdo_ipc_interfaces_IGateMPSupport_Interface__BASE__C_offset)))
#endif
...
__extern ti_sdo_ipc_interfaces_IGateMPSupport_Handle ti_sdo_ipc_interfaces_IGateMPSupport_create(ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod, xdc_runtime_IGateProvider_Handle localGate, const ti_sdo_ipc_interfaces_IGateMPSupport_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(ti_sdo_ipc_interfaces_IGateMPSupport_delete, "ti_sdo_ipc_interfaces_IGateMPSupport_delete")
__extern xdc_Void ti_sdo_ipc_interfaces_IGateMPSupport_delete(ti_sdo_ipc_interfaces_IGateMPSupport_Handle *__inst);
...
/* query */
static inline xdc_Bool ti_sdo_ipc_interfaces_IGateMPSupport_query(ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod, xdc_Int qual);
static inline xdc_Bool ti_sdo_ipc_interfaces_IGateMPSupport_query( ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod, xdc_Int qual )
{
...
/* getReservedMask */
static inline xdc_Bits32 *ti_sdo_ipc_interfaces_IGateMPSupport_getReservedMask(ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod);
static inline xdc_Bits32 *ti_sdo_ipc_interfaces_IGateMPSupport_getReservedMask( ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod )
{
    return __mod->getReservedMask();
}

/* sharedMemReq */
static inline xdc_SizeT ti_sdo_ipc_interfaces_IGateMPSupport_sharedMemReq(ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod, const ti_sdo_ipc_interfaces_IGateMPSupport_Params *params);
static inline xdc_SizeT ti_sdo_ipc_interfaces_IGateMPSupport_sharedMemReq( ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod, const ti_sdo_ipc_interfaces_IGateMPSupport_Params *params )
{
    return __mod->sharedMemReq(params);
}
...
/* query_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sdo_ipc_interfaces_IGateMPSupport_query_FxnT)(xdc_Int qual);
static inline ti_sdo_ipc_interfaces_IGateMPSupport_query_FxnT ti_sdo_ipc_interfaces_IGateMPSupport_query_fxnP(ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod);
static inline ti_sdo_ipc_interfaces_IGateMPSupport_query_FxnT ti_sdo_ipc_interfaces_IGateMPSupport_query_fxnP(ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod)
{
    return (ti_sdo_ipc_interfaces_IGateMPSupport_query_FxnT)__mod->query;
}

/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*ti_sdo_ipc_interfaces_IGateMPSupport_enter_FxnT)(xdc_Void *__inst);
...
/* leave_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_interfaces_IGateMPSupport_leave_FxnT)(xdc_Void *__inst, xdc_IArg key);
...
static inline ti_sdo_ipc_interfaces_IGateMPSupport_getReservedMask_FxnT ti_sdo_ipc_interfaces_IGateMPSupport_getReservedMask_fxnP(ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod);
static inline ti_sdo_ipc_interfaces_IGateMPSupport_getReservedMask_FxnT ti_sdo_ipc_interfaces_IGateMPSupport_getReservedMask_fxnP(ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod)
{
    return (ti_sdo_ipc_interfaces_IGateMPSupport_getReservedMask_FxnT)__mod->getReservedMask;
}

/* sharedMemReq_{FxnT,fxnP} */
typedef xdc_SizeT (*ti_sdo_ipc_interfaces_IGateMPSupport_sharedMemReq_FxnT)(const ti_sdo_ipc_interfaces_IGateMPSupport_Params* params);
static inline ti_sdo_ipc_interfaces_IGateMPSupport_sharedMemReq_FxnT ti_sdo_ipc_interfaces_IGateMPSupport_sharedMemReq_fxnP(ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod);
static inline ti_sdo_ipc_interfaces_IGateMPSupport_sharedMemReq_FxnT ti_sdo_ipc_interfaces_IGateMPSupport_sharedMemReq_fxnP(ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod)
{
    return (ti_sdo_ipc_interfaces_IGateMPSupport_sharedMemReq_FxnT)__mod->sharedMemReq;
}
