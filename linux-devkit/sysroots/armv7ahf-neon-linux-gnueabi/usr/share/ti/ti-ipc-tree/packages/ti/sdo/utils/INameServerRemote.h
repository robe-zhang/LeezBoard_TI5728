...
#define ti_sdo_utils_INameServerRemote___VERS 200
...
struct ti_sdo_utils_INameServerRemote_Fxns__ {
    ...
    xdc_Int (*get)(void* __inst, xdc_String instanceName, xdc_String name, xdc_Ptr value, xdc_UInt32* valueLen, xdc_runtime_knl_ISync_Handle syncHandle, xdc_runtime_Error_Block* eb);
    xdc_runtime_Types_SysFxns2 __sfxns;
};
#ifndef ti_sdo_utils_INameServerRemote_Module__BASE__CR

/* Interface__BASE__C */
__extern const xdc_runtime_Types_Base ti_sdo_utils_INameServerRemote_Interface__BASE__C;
#else
#define ti_sdo_utils_INameServerRemote_Interface__BASE__C (*((xdc_runtime_Types_Base *)(xdcRomConstPtr + ti_sdo_utils_INameServerRemote_Interface__BASE__C_offset)))
#endif
...
__extern ti_sdo_utils_INameServerRemote_Handle ti_sdo_utils_INameServerRemote_create(ti_sdo_utils_INameServerRemote_Module __mod, xdc_UInt16 procId, const ti_sdo_utils_INameServerRemote_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(ti_sdo_utils_INameServerRemote_delete, "ti_sdo_utils_INameServerRemote_delete")
__extern xdc_Void ti_sdo_utils_INameServerRemote_delete(ti_sdo_utils_INameServerRemote_Handle *__inst);
...
/* attach */
static inline xdc_Int ti_sdo_utils_INameServerRemote_attach(ti_sdo_utils_INameServerRemote_Module __mod, xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr);
static inline xdc_Int ti_sdo_utils_INameServerRemote_attach( ti_sdo_utils_INameServerRemote_Module __mod, xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr )
{
...
/* detach */
static inline xdc_Int ti_sdo_utils_INameServerRemote_detach(ti_sdo_utils_INameServerRemote_Module __mod, xdc_UInt16 remoteProcId);
static inline xdc_Int ti_sdo_utils_INameServerRemote_detach( ti_sdo_utils_INameServerRemote_Module __mod, xdc_UInt16 remoteProcId )
{
...
/* sharedMemReq */
static inline xdc_SizeT ti_sdo_utils_INameServerRemote_sharedMemReq(ti_sdo_utils_INameServerRemote_Module __mod, xdc_Ptr sharedAddr);
static inline xdc_SizeT ti_sdo_utils_INameServerRemote_sharedMemReq( ti_sdo_utils_INameServerRemote_Module __mod, xdc_Ptr sharedAddr )
{
...
/* attach_{FxnT,fxnP} */
typedef xdc_Int (*ti_sdo_utils_INameServerRemote_attach_FxnT)(xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr);
static inline ti_sdo_utils_INameServerRemote_attach_FxnT ti_sdo_utils_INameServerRemote_attach_fxnP(ti_sdo_utils_INameServerRemote_Module __mod);
static inline ti_sdo_utils_INameServerRemote_attach_FxnT ti_sdo_utils_INameServerRemote_attach_fxnP(ti_sdo_utils_INameServerRemote_Module __mod)
{
    return (ti_sdo_utils_INameServerRemote_attach_FxnT)__mod->attach;
}

/* detach_{FxnT,fxnP} */
typedef xdc_Int (*ti_sdo_utils_INameServerRemote_detach_FxnT)(xdc_UInt16 remoteProcId);
static inline ti_sdo_utils_INameServerRemote_detach_FxnT ti_sdo_utils_INameServerRemote_detach_fxnP(ti_sdo_utils_INameServerRemote_Module __mod);
static inline ti_sdo_utils_INameServerRemote_detach_FxnT ti_sdo_utils_INameServerRemote_detach_fxnP(ti_sdo_utils_INameServerRemote_Module __mod)
{
    return (ti_sdo_utils_INameServerRemote_detach_FxnT)__mod->detach;
}

/* sharedMemReq_{FxnT,fxnP} */
typedef xdc_SizeT (*ti_sdo_utils_INameServerRemote_sharedMemReq_FxnT)(xdc_Ptr sharedAddr);
static inline ti_sdo_utils_INameServerRemote_sharedMemReq_FxnT ti_sdo_utils_INameServerRemote_sharedMemReq_fxnP(ti_sdo_utils_INameServerRemote_Module __mod);
static inline ti_sdo_utils_INameServerRemote_sharedMemReq_FxnT ti_sdo_utils_INameServerRemote_sharedMemReq_fxnP(ti_sdo_utils_INameServerRemote_Module __mod)
{
    return (ti_sdo_utils_INameServerRemote_sharedMemReq_FxnT)__mod->sharedMemReq;
}

/* get_{FxnT,fxnP} */
typedef xdc_Int (*ti_sdo_utils_INameServerRemote_get_FxnT)(xdc_Void *__inst, xdc_String instanceName, xdc_String name, xdc_Ptr value, xdc_UInt32* valueLen, xdc_runtime_knl_ISync_Handle syncHandle, xdc_runtime_Error_Block* eb);
