...
#define ti_sdo_ipc_interfaces_IMessageQTransport___VERS 200
...
/* ErrFxn */
typedef xdc_Void (*ti_sdo_ipc_interfaces_IMessageQTransport_ErrFxn)(ti_sdo_ipc_interfaces_IMessageQTransport_Reason __arg1, ti_sdo_ipc_interfaces_IMessageQTransport_Handle __arg2, xdc_Ptr __arg3, xdc_UArg __arg4);
...
struct ti_sdo_ipc_interfaces_IMessageQTransport_Fxns__ {
    ...
    xdc_Int (*getStatus)(void* __inst);
    xdc_Bool (*put)(void* __inst, xdc_Ptr msg);
    xdc_Bool (*control)(void* __inst, xdc_UInt cmd, xdc_UArg cmdArg);
    xdc_runtime_Types_SysFxns2 __sfxns;
};
#ifndef ti_sdo_ipc_interfaces_IMessageQTransport_Module__BASE__CR

/* Interface__BASE__C */
__extern const xdc_runtime_Types_Base ti_sdo_ipc_interfaces_IMessageQTransport_Interface__BASE__C;
#else
#define ti_sdo_ipc_interfaces_IMessageQTransport_Interface__BASE__C (*((xdc_runtime_Types_Base *)(xdcRomConstPtr + ti_sdo_ipc_interfaces_IMessageQTransport_Interface__BASE__C_offset)))
#endif
...
__extern ti_sdo_ipc_interfaces_IMessageQTransport_Handle ti_sdo_ipc_interfaces_IMessageQTransport_create(ti_sdo_ipc_interfaces_IMessageQTransport_Module __mod, xdc_UInt16 procId, const ti_sdo_ipc_interfaces_IMessageQTransport_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(ti_sdo_ipc_interfaces_IMessageQTransport_delete, "ti_sdo_ipc_interfaces_IMessageQTransport_delete")
__extern xdc_Void ti_sdo_ipc_interfaces_IMessageQTransport_delete(ti_sdo_ipc_interfaces_IMessageQTransport_Handle *__inst);
...
/* setErrFxn */
static inline xdc_Void ti_sdo_ipc_interfaces_IMessageQTransport_setErrFxn(ti_sdo_ipc_interfaces_IMessageQTransport_Module __mod, ti_sdo_ipc_interfaces_IMessageQTransport_ErrFxn errFxn);
static inline xdc_Void ti_sdo_ipc_interfaces_IMessageQTransport_setErrFxn( ti_sdo_ipc_interfaces_IMessageQTransport_Module __mod, ti_sdo_ipc_interfaces_IMessageQTransport_ErrFxn errFxn )
{
    __mod->setErrFxn(errFxn);
}
...
typedef xdc_Void (*ti_sdo_ipc_interfaces_IMessageQTransport_setErrFxn_FxnT)(ti_sdo_ipc_interfaces_IMessageQTransport_ErrFxn errFxn);
static inline ti_sdo_ipc_interfaces_IMessageQTransport_setErrFxn_FxnT ti_sdo_ipc_interfaces_IMessageQTransport_setErrFxn_fxnP(ti_sdo_ipc_interfaces_IMessageQTransport_Module __mod);
static inline ti_sdo_ipc_interfaces_IMessageQTransport_setErrFxn_FxnT ti_sdo_ipc_interfaces_IMessageQTransport_setErrFxn_fxnP(ti_sdo_ipc_interfaces_IMessageQTransport_Module __mod)
{
    return (ti_sdo_ipc_interfaces_IMessageQTransport_setErrFxn_FxnT)__mod->setErrFxn;
}

/* getStatus_{FxnT,fxnP} */
typedef xdc_Int (*ti_sdo_ipc_interfaces_IMessageQTransport_getStatus_FxnT)(xdc_Void *__inst);
...
/* put_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sdo_ipc_interfaces_IMessageQTransport_put_FxnT)(xdc_Void *__inst, xdc_Ptr msg);
...
/* control_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sdo_ipc_interfaces_IMessageQTransport_control_FxnT)(xdc_Void *__inst, xdc_UInt cmd, xdc_UArg cmdArg);
