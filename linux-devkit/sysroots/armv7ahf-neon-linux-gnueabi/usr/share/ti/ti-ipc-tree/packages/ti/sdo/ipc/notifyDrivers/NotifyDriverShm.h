...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm___VERS 200
...
typedef const xdc_UInt32 *__CARRAY1_ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Instance_State__regChart;
...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsEnabled__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsEnabled*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsEnabled__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsEnabled (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsEnabled__C)
#endif
...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsIncluded__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsIncluded*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsIncluded__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsIncluded (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsIncluded__C)
#endif
...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsMask__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsMask*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsMask__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsMask (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__diagsMask__C)
#endif
...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__gateObj__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__gateObj*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__gateObj__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__gateObj (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__gateObj__C)
#endif
...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__gatePrms__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__gatePrms*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__gatePrms__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__gatePrms (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__gatePrms__C)
#endif
...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__id__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__id*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__id__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__id (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__id__C)
#endif
...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerDefined__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerDefined*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerDefined__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerDefined (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerDefined__C)
#endif
...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerObj__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerObj*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerObj__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerObj (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerObj__C)
#endif
...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn0__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn0*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn0__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn0 (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn0__C)
#endif
...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn1__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn1*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn1__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn1 (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn1__C)
#endif
...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn2__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn2*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn2__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn2 (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn2__C)
#endif
...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn4__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn4*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn4__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn4 (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn4__C)
#endif
...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn8__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn8*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn8__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn8 (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__loggerFxn8__C)
#endif
...
#ifdef ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__count__CR
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__count__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__count*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__count__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__count (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__count__C)
#endif
...
#ifdef ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__heap__CR
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__heap__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__heap*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__heap__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__heap (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__heap__C)
#endif
...
#ifdef ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__sizeof__CR
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__sizeof__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__sizeof*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__sizeof__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__sizeof (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__sizeof__C)
#endif
...
#ifdef ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__table__CR
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__table__C (*((CT__ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__table*)(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__table__C_offset)))
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__table (ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__table__C)
#endif
...
struct ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Fxns__ {
    ...
    xdc_Void (*registerEvent)(ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Handle __inst, xdc_UInt32 eventId);
    xdc_Void (*unregisterEvent)(ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Handle __inst, xdc_UInt32 eventId);
    xdc_Int (*sendEvent)(ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Handle __inst, xdc_UInt32 eventId, xdc_UInt32 payload, xdc_Bool waitClear);
    xdc_Void (*disable)(ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Handle __inst);
    xdc_Void (*enable)(ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Handle __inst);
    xdc_Void (*disableEvent)(ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Handle __inst, xdc_UInt32 eventId);
    xdc_Void (*enableEvent)(ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Handle __inst, xdc_UInt32 eventId);
    xdc_Void (*setNotifyHandle)(ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Handle __inst, xdc_Ptr driverHandle);
    xdc_runtime_Types_SysFxns2 __sfxns;
};
#ifndef ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__FXNS__CR

/* Module__FXNS__C */
__extern const ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Fxns__ ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__FXNS__C;
#else
#define ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__FXNS__C (*(xdcRomConstPtr + ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Module__FXNS__C_offset))
#endif
...
__extern xdc_Int ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Instance_init__E(ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object *__obj, const ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Params *__prms, xdc_runtime_Error_Block *__eb);
...
__extern void ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Instance_finalize__E(ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object *__obj, int __ec);
...
__extern xdc_Ptr ti_sdo_ipc_notifyDrivers_NotifyDriverShm_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
