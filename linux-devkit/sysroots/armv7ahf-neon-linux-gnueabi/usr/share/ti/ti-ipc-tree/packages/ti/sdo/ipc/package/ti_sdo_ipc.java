...
public class ti_sdo_ipc
{
    ...
    void GateMP$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sdo_ipc_GateMP_Handle__label__E", "ti_sdo_ipc_GateMP_Module__startupDone__E", "ti_sdo_ipc_GateMP_Object__create__E", "ti_sdo_ipc_GateMP_Object__delete__E", "ti_sdo_ipc_GateMP_Object__get__E", "ti_sdo_ipc_GateMP_Object__first__E", "ti_sdo_ipc_GateMP_Object__next__E", "ti_sdo_ipc_GateMP_Params__init__E", "ti_sdo_ipc_GateMP_createLocal__E", "ti_sdo_ipc_GateMP_attach__E", "ti_sdo_ipc_GateMP_detach__E", "ti_sdo_ipc_GateMP_getRegion0ReservedSize__E", "ti_sdo_ipc_GateMP_setRegion0Reserved__E", "ti_sdo_ipc_GateMP_openRegion0Reserved__E", "ti_sdo_ipc_GateMP_setDefaultRemote__E", "ti_sdo_ipc_GateMP_start__E", "ti_sdo_ipc_GateMP_stop__E", "ti_sdo_ipc_GateMP_getSharedAddr__E"));
    ...
    void MessageQ$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sdo_ipc_MessageQ_Handle__label__E", "ti_sdo_ipc_MessageQ_Module__startupDone__E", "ti_sdo_ipc_MessageQ_Object__create__E", "ti_sdo_ipc_MessageQ_Object__delete__E", "ti_sdo_ipc_MessageQ_Object__get__E", "ti_sdo_ipc_MessageQ_Object__first__E", "ti_sdo_ipc_MessageQ_Object__next__E", "ti_sdo_ipc_MessageQ_Params__init__E", "ti_sdo_ipc_MessageQ_registerTransport__E", "ti_sdo_ipc_MessageQ_unregisterTransport__E"));
    ...
    void Notify$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sdo_ipc_Notify_Handle__label__E", "ti_sdo_ipc_Notify_Module__startupDone__E", "ti_sdo_ipc_Notify_Object__create__E", "ti_sdo_ipc_Notify_Object__delete__E", "ti_sdo_ipc_Notify_Object__get__E", "ti_sdo_ipc_Notify_Object__first__E", "ti_sdo_ipc_Notify_Object__next__E", "ti_sdo_ipc_Notify_Params__init__E", "ti_sdo_ipc_Notify_detach__E", "ti_sdo_ipc_Notify_exec__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
