...
#define ti_sdo_ipc_interfaces_INotifyDriver___VERS 200
...
struct ti_sdo_ipc_interfaces_INotifyDriver_Fxns__ {
    ...
    xdc_Void (*registerEvent)(void* __inst, xdc_UInt32 eventId);
    xdc_Void (*unregisterEvent)(void* __inst, xdc_UInt32 eventId);
    xdc_Int (*sendEvent)(void* __inst, xdc_UInt32 eventId, xdc_UInt32 payload, xdc_Bool waitClear);
    xdc_Void (*disable)(void* __inst);
    xdc_Void (*enable)(void* __inst);
    xdc_Void (*disableEvent)(void* __inst, xdc_UInt32 eventId);
    xdc_Void (*enableEvent)(void* __inst, xdc_UInt32 eventId);
    xdc_Void (*setNotifyHandle)(void* __inst, xdc_Ptr driverHandle);
    xdc_runtime_Types_SysFxns2 __sfxns;
};
#ifndef ti_sdo_ipc_interfaces_INotifyDriver_Module__BASE__CR

/* Interface__BASE__C */
__extern const xdc_runtime_Types_Base ti_sdo_ipc_interfaces_INotifyDriver_Interface__BASE__C;
#else
#define ti_sdo_ipc_interfaces_INotifyDriver_Interface__BASE__C (*((xdc_runtime_Types_Base *)(xdcRomConstPtr + ti_sdo_ipc_interfaces_INotifyDriver_Interface__BASE__C_offset)))
#endif
...
__extern ti_sdo_ipc_interfaces_INotifyDriver_Handle ti_sdo_ipc_interfaces_INotifyDriver_create(ti_sdo_ipc_interfaces_INotifyDriver_Module __mod, const ti_sdo_ipc_interfaces_INotifyDriver_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(ti_sdo_ipc_interfaces_INotifyDriver_delete, "ti_sdo_ipc_interfaces_INotifyDriver_delete")
__extern xdc_Void ti_sdo_ipc_interfaces_INotifyDriver_delete(ti_sdo_ipc_interfaces_INotifyDriver_Handle *__inst);
...
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_registerEvent_FxnT)(xdc_Void *__inst, xdc_UInt32 eventId);
...
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_unregisterEvent_FxnT)(xdc_Void *__inst, xdc_UInt32 eventId);
...
typedef xdc_Int (*ti_sdo_ipc_interfaces_INotifyDriver_sendEvent_FxnT)(xdc_Void *__inst, xdc_UInt32 eventId, xdc_UInt32 payload, xdc_Bool waitClear);
...
/* disable_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_disable_FxnT)(xdc_Void *__inst);
...
/* enable_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_enable_FxnT)(xdc_Void *__inst);
...
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_disableEvent_FxnT)(xdc_Void *__inst, xdc_UInt32 eventId);
...
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_enableEvent_FxnT)(xdc_Void *__inst, xdc_UInt32 eventId);
...
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_setNotifyHandle_FxnT)(xdc_Void *__inst, xdc_Ptr driverHandle);
