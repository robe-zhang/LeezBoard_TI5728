...
public class ti_runtime_ompbios
{
    ...
    void OpenMP$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("hwSemCount", Proto.Elm.newCNum("(xdc_Int32)"), 9L, "w");
