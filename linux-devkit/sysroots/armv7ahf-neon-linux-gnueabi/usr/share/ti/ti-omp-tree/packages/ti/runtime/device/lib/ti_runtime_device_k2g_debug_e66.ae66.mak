...
package/lib/lib/ti_runtime_device_k2g_debug_e66/package/package_ti.runtime.device.oe66: package/package_ti.runtime.device.c lib/ti_runtime_device_k2g_debug_e66.ae66.mak
	...
	$(RM) $@
	@$(MSG) cle66 $< ...
	$(ti.targets.elf.C66.rootDir)/bin/cl6x -c  --gcc --mem_model:data=far --verbose_diagnostics --display_error_number --diag_error=225 -k --diag_error=9 --diag_warning=179 --diag_remark=188 --diag_suppress=880  -mv6600 --abi=eabi -eo.oe66 -ea.se66  -DTI_66AK2G -DDEVICE_K2G=1 -DTOMP_TRACE_LEVEL=0 -DTOMP_CHECK_LEVEL=1 -Dxdc_target_name__=C66 -Dxdc_target_types__=ti/targets/elf/std.h -Dxdc_bld__profile_ti_runtime_device_k2g_debug -Dxdc_bld__vers_1_0_8_2_2 -g --opt_level=0 --gen_func_subsections=on   $(XDCINCS) -I$(ti.targets.elf.C66.rootDir)/include -fs=./package/lib/lib/ti_runtime_device_k2g_debug_e66/package -fr=./package/lib/lib/ti_runtime_device_k2g_debug_e66/package -fc $<
	$(MKDEP) -a $@.dep -p package/lib/lib/ti_runtime_device_k2g_debug_e66/package -s oe66 $< -C   --gcc --mem_model:data=far --verbose_diagnostics --display_error_number --diag_error=225 -k --diag_error=9 --diag_warning=179 --diag_remark=188 --diag_suppress=880  -mv6600 --abi=eabi -eo.oe66 -ea.se66  -DTI_66AK2G -DDEVICE_K2G=1 -DTOMP_TRACE_LEVEL=0 -DTOMP_CHECK_LEVEL=1 -Dxdc_target_name__=C66 -Dxdc_target_types__=ti/targets/elf/std.h -Dxdc_bld__profile_ti_runtime_device_k2g_debug -Dxdc_bld__vers_1_0_8_2_2 -g --opt_level=0 --gen_func_subsections=on   $(XDCINCS) -I$(ti.targets.elf.C66.rootDir)/include -fs=./package/lib/lib/ti_runtime_device_k2g_debug_e66/package -fr=./package/lib/lib/ti_runtime_device_k2g_debug_e66/package
	-@$(FIXDEP) $@.dep $@.dep
...
package/lib/lib/ti_runtime_device_k2g_debug_e66/src/qmss_device.oe66: src/qmss_device.c lib/ti_runtime_device_k2g_debug_e66.ae66.mak
	...
	$(RM) $@
	@$(MSG) cle66 $< ...
	$(ti.targets.elf.C66.rootDir)/bin/cl6x -c  --gcc --mem_model:data=far --verbose_diagnostics --display_error_number --diag_error=225 -k --diag_error=9 --diag_warning=179 --diag_remark=188 --diag_suppress=880  -mv6600 --abi=eabi -eo.oe66 -ea.se66  -DTI_66AK2G -DDEVICE_K2G=1 -DTOMP_TRACE_LEVEL=0 -DTOMP_CHECK_LEVEL=1 -Dxdc_target_name__=C66 -Dxdc_target_types__=ti/targets/elf/std.h -Dxdc_bld__profile_ti_runtime_device_k2g_debug -Dxdc_bld__vers_1_0_8_2_2 -g --opt_level=0 --gen_func_subsections=on   $(XDCINCS) -I$(ti.targets.elf.C66.rootDir)/include -fs=./package/lib/lib/ti_runtime_device_k2g_debug_e66/src -fr=./package/lib/lib/ti_runtime_device_k2g_debug_e66/src -fc $<
	$(MKDEP) -a $@.dep -p package/lib/lib/ti_runtime_device_k2g_debug_e66/src -s oe66 $< -C   --gcc --mem_model:data=far --verbose_diagnostics --display_error_number --diag_error=225 -k --diag_error=9 --diag_warning=179 --diag_remark=188 --diag_suppress=880  -mv6600 --abi=eabi -eo.oe66 -ea.se66  -DTI_66AK2G -DDEVICE_K2G=1 -DTOMP_TRACE_LEVEL=0 -DTOMP_CHECK_LEVEL=1 -Dxdc_target_name__=C66 -Dxdc_target_types__=ti/targets/elf/std.h -Dxdc_bld__profile_ti_runtime_device_k2g_debug -Dxdc_bld__vers_1_0_8_2_2 -g --opt_level=0 --gen_func_subsections=on   $(XDCINCS) -I$(ti.targets.elf.C66.rootDir)/include -fs=./package/lib/lib/ti_runtime_device_k2g_debug_e66/src -fr=./package/lib/lib/ti_runtime_device_k2g_debug_e66/src
	-@$(FIXDEP) $@.dep $@.dep
