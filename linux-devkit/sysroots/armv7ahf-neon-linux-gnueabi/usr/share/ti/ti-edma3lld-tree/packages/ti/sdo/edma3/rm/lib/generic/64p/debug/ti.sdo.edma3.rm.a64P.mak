...
package/lib/lib/generic/64p/debug/ti.sdo.edma3.rm/package/package_ti.sdo.edma3.rm.o64P: package/package_ti.sdo.edma3.rm.c lib/generic/64p/debug/ti.sdo.edma3.rm.a64P.mak
	...
	$(RM) $@
	@$(MSG) cl64P $< ...
	$(ti.targets.C64P.rootDir)/bin/cl6x -c  -qq -pdsw225 -mv64p -eo.o64P -ea.s64P  -mi10 -mo  -D_DEBUG_=1  -DGENERIC  -Dxdc_target_name__=C64P -Dxdc_target_types__=ti/targets/std.h -Dxdc_bld__profile_debug -Dxdc_bld__vers_1_0_8_2_2 -g  $(XDCINCS) -I$(ti.targets.C64P.rootDir)/include -fs=./package/lib/lib/generic/64p/debug/ti.sdo.edma3.rm/package -fr=./package/lib/lib/generic/64p/debug/ti.sdo.edma3.rm/package -fc $<
	$(MKDEP) -a $@.dep -p package/lib/lib/generic/64p/debug/ti.sdo.edma3.rm/package -s o64P $< -C   -qq -pdsw225 -mv64p -eo.o64P -ea.s64P  -mi10 -mo  -D_DEBUG_=1  -DGENERIC  -Dxdc_target_name__=C64P -Dxdc_target_types__=ti/targets/std.h -Dxdc_bld__profile_debug -Dxdc_bld__vers_1_0_8_2_2 -g  $(XDCINCS) -I$(ti.targets.C64P.rootDir)/include -fs=./package/lib/lib/generic/64p/debug/ti.sdo.edma3.rm/package -fr=./package/lib/lib/generic/64p/debug/ti.sdo.edma3.rm/package
	-@$(FIXDEP) $@.dep $@.dep
...
package/lib/lib/generic/64p/debug/ti.sdo.edma3.rm/src/edma3resmgr.o64P: src/edma3resmgr.c lib/generic/64p/debug/ti.sdo.edma3.rm.a64P.mak
	...
	$(RM) $@
	@$(MSG) cl64P $< ...
	$(ti.targets.C64P.rootDir)/bin/cl6x -c  -qq -pdsw225 -mv64p -eo.o64P -ea.s64P  -mi10 -mo  -D_DEBUG_=1  -DGENERIC  -Dxdc_target_name__=C64P -Dxdc_target_types__=ti/targets/std.h -Dxdc_bld__profile_debug -Dxdc_bld__vers_1_0_8_2_2 -g  $(XDCINCS) -I$(ti.targets.C64P.rootDir)/include -fs=./package/lib/lib/generic/64p/debug/ti.sdo.edma3.rm/src -fr=./package/lib/lib/generic/64p/debug/ti.sdo.edma3.rm/src -fc $<
	$(MKDEP) -a $@.dep -p package/lib/lib/generic/64p/debug/ti.sdo.edma3.rm/src -s o64P $< -C   -qq -pdsw225 -mv64p -eo.o64P -ea.s64P  -mi10 -mo  -D_DEBUG_=1  -DGENERIC  -Dxdc_target_name__=C64P -Dxdc_target_types__=ti/targets/std.h -Dxdc_bld__profile_debug -Dxdc_bld__vers_1_0_8_2_2 -g  $(XDCINCS) -I$(ti.targets.C64P.rootDir)/include -fs=./package/lib/lib/generic/64p/debug/ti.sdo.edma3.rm/src -fr=./package/lib/lib/generic/64p/debug/ti.sdo.edma3.rm/src
	-@$(FIXDEP) $@.dep $@.dep
