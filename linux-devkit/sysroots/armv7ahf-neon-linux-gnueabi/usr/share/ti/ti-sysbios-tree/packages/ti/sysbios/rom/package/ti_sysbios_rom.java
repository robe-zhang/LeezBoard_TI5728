...
public class ti_sysbios_rom
{
    ...
    void ROM$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.rom.ROM.CC13X2", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.CC13X2", 6));
        om.bind("ti.sysbios.rom.ROM.CC26X2_NO_OAD", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.CC26X2_NO_OAD", 7));
        om.bind("ti.sysbios.rom.ROM.CC2652R2", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.CC2652R2", 8));
        om.bind("ti.sysbios.rom.ROM.CC1352", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.CC1352", 9));
        om.bind("ti.sysbios.rom.ROM.CC2652", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.CC2652", 10));
    }
    ...
    void ROM$$SINGLETONS()
    {
        ...
        vo.bind("CC2652R2", om.findStrict("ti.sysbios.rom.ROM.CC2652R2", "ti.sysbios.rom"));
