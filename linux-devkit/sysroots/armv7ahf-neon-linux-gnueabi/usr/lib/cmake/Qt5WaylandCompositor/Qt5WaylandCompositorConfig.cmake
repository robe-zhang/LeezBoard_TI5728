...
if (NOT TARGET Qt5::WaylandCompositor)
    ...
    set(Qt5WaylandCompositor_PRIVATE_INCLUDE_DIRS
        "${_qt5WaylandCompositor_install_prefix}/include/qt5/QtWaylandCompositor/5.7.1"
        "${_qt5WaylandCompositor_install_prefix}/include/qt5/QtWaylandCompositor/5.7.1/QtWaylandCompositor"
    )
    ...
    macro(_populate_WaylandCompositor_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WaylandCompositor_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WaylandCompositor_check_file_exists(${imported_location})
