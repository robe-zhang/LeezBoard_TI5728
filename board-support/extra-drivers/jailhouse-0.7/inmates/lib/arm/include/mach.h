...
#elif defined(CONFIG_MACH_AM57XX)
#define CON_TYPE	"8250"
#ifdef USE_UART9
#define CON_BASE	0x48424000
#else
#define CON_BASE	0x48020000
#endif
#define CON_DIVIDER	0x26

//#define CON_CLOCK_REG	0x01c2006c
//#define CON_GATE_NR	23

#define GICD_V2_BASE	((void *)0x48211000)
#define GICC_V2_BASE	((void *)0x48212000)
